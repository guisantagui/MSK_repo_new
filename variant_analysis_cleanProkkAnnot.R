...
source("C:/Users/Guillem/Documents/PhD/comput/wrkng_dirs_clean/MSK_repo_new/variantAnalysis_functions.R")
...
strainNames <- gsub(".fasta|.fna", 
                    replacement = "", 
                    list.files(path = "C:/Users/Guillem/Documents/PhD/comput/Sequences/newSeqs/Archive"))
