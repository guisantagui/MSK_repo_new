setwd("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/hybrid")
...
load("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/newData/metabolitePeaks_newData.RData")
load("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/oldDataGood/metabolitePeaks_oldData.RData")
...
save(compNames, file = "compNames_hybrid.RData")
...
p + geom_col() + 
        ...
        ggsave("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/hybrid/meanPeakAreaRaw_hybrid.jpg")
...
ggsave("sample_boxplot_hybrid.pdf",width = 9, height = 5)  
...
ggsave("metabolite_boxplot_hybrid.pdf",width = 7, height = 11)  
...
ggsave("const_metaboliteds_hybrid.pdf",width = 7, height = 14)  
...
ggsave("normmethod_silh_hybrid.pdf") 
...
ggsave("sample_boxplot_ccmn_hybrid.pdf",width = 9, height = 5)  
...
ggsave("metabolite_boxplot_ccmn_hybrid.pdf",width = 7, height = 11)  
...
save(alldataMet, file = "alldataMet_hybrid.RData")
#LogTransform Data
...
save(missingMet, file = "missingMet_hybrid.RData")
...
ggsave("normmethod_dist_normalizeMets_hybrid.pdf")
...
ggsave("normmethod_silh_normalizeMets_hybrid.pdf") 
...
ggsave("pvaluehist_pre_hybrid.jpeg", device = "jpeg")
...
ggsave("pvaluehist_nomis_hybrid.jpeg", device = "jpeg")
...
ggsave("pvaluehist_ccmn_hybrid.jpeg", device = "jpeg")
...
ggsave("pvaluehist_ruvrand_hybrid.jpeg", device = "jpeg")
...
ggsave("pvaluehist_ruvrandclust_hybrid.jpeg", device = "jpeg")
...
ggsave("pvaluehist_median_hybrid.jpeg", device = "jpeg")
...
ggsave("pvaluehist_mean_hybrid.jpeg", device = "jpeg")
...
sink("ranksAllStrainsMeths_hybrid.csv", type = "output")
...
ggsave("meanRanksTstatVert_hybrid.pdf")
ggsave("meanRanksaTstatVert_hybrid.tiff", device = "tiff")   
...
ccmn_norm_mets_hybrid <- norm_ccmn_normalizemets$featuredata
colnames(ccmn_norm_mets_hybrid) <- as.character(missingMet$metabolitedata$names[missingMet$metabolitedata$IS != 1])
save(ccmn_norm_mets_hybrid, file = "ccmn_norm_mets_hybrid.RData")
