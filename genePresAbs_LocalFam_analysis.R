...
strain_genes <- list("PA14" = as.character(PA14$PATRIC.genus.specific.families..PLfams.), "F22031" = as.character(F22031$PATRIC.genus.specific.families..PLfams.), 
                     "F30658" = as.character(F30658$PATRIC.genus.specific.families..PLfams.), "F34365" = as.character(F34365$PATRIC.genus.specific.families..PLfams.), 
                     "F63912" = as.character(F63912$PATRIC.genus.specific.families..PLfams.), "F9670" = as.character(F9670$PATRIC.genus.specific.families..PLfams.), 
                     "H27930" = as.character(H27930$PATRIC.genus.specific.families..PLfams.), "H47921" = as.character(H47921$PATRIC.genus.specific.families..PLfams.),
                     "H5708" = as.character(H5708$PATRIC.genus.specific.families..PLfams.), "M1608" = as.character(M1608$PATRIC.genus.specific.families..PLfams.), 
                     "M37351" = as.character(M37351$PATRIC.genus.specific.families..PLfams.), "M6075" = as.character(M6075$PATRIC.genus.specific.families..PLfams.), 
                     "M74707" = as.character(M74707$PATRIC.genus.specific.families..PLfams.), "S86968" = as.character(S86968$PATRIC.genus.specific.families..PLfams.), 
                     "T38079" = as.character(T38079$PATRIC.genus.specific.families..PLfams.), "T52373" = as.character(T52373$PATRIC.genus.specific.families..PLfams.), 
                     "T6313" = as.character(T6313$PATRIC.genus.specific.families..PLfams.), "T63266" = as.character(T63266$PATRIC.genus.specific.families..PLfams.), 
                     "W16407" = as.character(W16407$PATRIC.genus.specific.families..PLfams.), "W25637" = as.character(W25637$PATRIC.genus.specific.families..PLfams.), 
                     "W36662" = as.character(W36662$PATRIC.genus.specific.families..PLfams.), "W45909" = as.character(W45909$PATRIC.genus.specific.families..PLfams.), 
                     "W60856" = as.character(W60856$PATRIC.genus.specific.families..PLfams.), "W70322" = as.character(W70322$PATRIC.genus.specific.families..PLfams.), 
                     "W91453" = as.character(W91453$PATRIC.genus.specific.families..PLfams.), "X78812" = as.character(X78812$PATRIC.genus.specific.families..PLfams.), 
                     "X9820" = as.character(X9820$PATRIC.genus.specific.families..PLfams.))

all_genes <- unique(unlist(strain_genes))
