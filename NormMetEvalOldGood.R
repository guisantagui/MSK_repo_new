setwd("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/oldDataGood")
...
#Load Names
sampleNames <- read_excel("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/metabolomics_jx/curated_peaks/sampleName1.xlsx")
colnames(sampleNames) <- paste(sampleNames[1, ], sampleNames[2, ], sep = '_')

#Load data
negativePeaks <- read_excel("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/metabolomics_jx/curated_peaks/ClinicalNeg-2.xlsx")
colnames(negativePeaks)[6:89] <- colnames(sampleNames)
negativePeaks$negativePeaks = 1
negativePeaks$mode <- "negative"

positivePeaks1 <- read_excel("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/metabolomics_jx/curated_peaks/ClinicalPos-4.1.xlsx")
colnames(positivePeaks1)[6:89] <- colnames(sampleNames)
positivePeaks1$positivePeaks1 = 1
positivePeaks1$mode <- "positive1"

positivePeaks2 <- read_excel("/Users/santamag/Desktop/GUILLEM/wrkng_dirs_clean/normMetAnal/metabolomics_jx/curated_peaks/ClinicalPos-4.2.xlsx")
